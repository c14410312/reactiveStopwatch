...
var button$ = _Rx.Observable.merge(_Rx.Observable.fromEvent(incButton, 'click').mapTo(inc), _Rx.Observable.fromEvent(decButton, 'click').mapTo(dec), _Rx.Observable.fromEvent(resButton, 'click').mapTo(res));

button$.scan(function (acc, update) {
	return update(acc);
